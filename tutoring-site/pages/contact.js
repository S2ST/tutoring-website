      ...
      <Grid container className={styles.contactContainer} alignItems="center">
        ...
        <Grid item container xs={12} sm={6} spacing={2} className={styles.innerContainer}>
          <Grid item xs={12}>
            ...
            <p className={styles.subtitle}>Interested but have some more questions? Not sure where to start? No problem! Simply reach out to us on one of our many points of contact.</p>
          </Grid>
          <Grid item xs={12}>
